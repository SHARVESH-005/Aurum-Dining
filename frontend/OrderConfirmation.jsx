...
function OrderConfirmation() {
  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen" style={{ backgroundImage: `url(${background})` }}>
  ...
  return (
    <div className="min-h-screen py-12 px-6" style={{ backgroundImage: `url(${background})` }}>
